  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <%      Cart cart = cartDA.checkRecord(studID);    
                if(cart == null){
                    cartDA.addRecord(stud.getId());
                    cart = cartDA.checkRecord(studID);  
                }  %>     
          ...
          <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Successful Order</h6>
            </div>
              <div class='card-body'>
