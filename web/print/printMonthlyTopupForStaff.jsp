...
<body>
    ...
    %>
    <h2 class="h2 text-center">Monthly Topup Summary Report for <%= monthReportHeader %><%=" "%><%= request.getParameter("year") %></h2>
    <div class="container-fluid">
        <%@include file="../include/dataTableMonthlyTopupForStaff.jsp" %>
    </div>
    <script>
        window.print();
