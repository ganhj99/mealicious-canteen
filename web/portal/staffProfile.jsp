...
<%-- Get current session user information --%>
    ...
    <%@ page import="control.MaintainStaffControl, control.MaintainWebUserControl, domain.Staff, domain.WebUser" %>
    <%  MaintainWebUserControl webUserControl = new MaintainWebUserControl();
        ...
        if (webUserControl.selectRecordWithUserId(currentUserId) != null){
            ...
            staff = staffControl.selectRecord(currentUserId);
        } else {
            ...
            <form class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" id="hireDate" name="hireDate" value="<%= staff.getDateStart() %>" disabled="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="position">Position</label>
                        <input class="form-control" type="text" id="position" name="position" value="<%= staff.getPosition() %>" disabled="">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                    ...
                    <div class="card-body">
                        <form class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    <div></div>
                                    <button class="btn btn-style-1 btn-primary" id="changePasswordBtn" type="button" data-toast-type="success" data-toast-icon="fe-icon-check-circle" data-toast-title="Success!" data-toast-message="Your password has been updated successfuly.">Change Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <form class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    <div></div>
                                    <button class="btn btn-style-1 btn-primary" id="verifyEmailBtn" type="button" data-toast-type="success" data-toast-icon="fe-icon-check-circle" data-toast-title="Great!" data-toast-message="We've sent you a verification email. Please check your mail inbox.">Verify Email</button>
                                </div>
                            </div>
                        </form>
                    </div>
