...
<%-- Get current session user information --%>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Monthly Topup Summary</h1>
          </div>
  ...
  <script>
	...
	$.ajax({
		type: 'post',
		url: '../include/dataTableMonthlyTopupForStaff.jsp',
		data: {
...
$('#printReport').click(function () {
    window.open('../print/printMonthlyTopupForStaff.jsp?year=' + $('#month').val().substring(0,4) + '&month=' + $('#month').val().substring(5));
});
